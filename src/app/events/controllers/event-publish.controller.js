...
angular.module('gliist')
    .controller('EventPublishCtrl', ['$scope', 'dialogService', '$state', 'eventsService', '$mdDialog', '$rootScope',
        function ($scope, dialogService, $state, eventsService, $mdDialog, $rootScope) {
