...
function BillingController (
  ...
  if ($stateParams.updatePaymentMethod === 'true') {
    dialogService.confirm(null, 'The payment transaction is unsuccessful.<br>Please try a different credit card. Thank you.', 'OK');
  }
...
angular.module('gliist').controller('BillingCtrl', BillingController);
