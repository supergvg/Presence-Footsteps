...
namespace gliist_server.Controllers
{
    ...
    public class RsvpController : ApiController
    {
        ...
        [HttpGet]
        [Route("share/{companyName}/{eventName}")]
        public HttpResponseMessage FacebookShare(string companyName, string eventName)
        {
            ...
            var description = "";
            var metaImage = "";
            const string template = "<html><head><meta property=\"og:title\" content=\"{1}\" /><meta property=\"og:description\" content=\"{2}\" />{3}</head><body></body></html>";
