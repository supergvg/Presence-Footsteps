...
module.exports = {
     ...
     */
    app_files: {
        modules_manifest: ['src/app/app.modules'],
        ...
        mockServer: ['mock-server/**/*.js']
    },

    /**
     * Source files for the mock front end development server.
     */
    server_files: {
        js: ['mock-server/**/*.js']
    },
    ...
    vendor_files: {
        js: [
            ...
            'vendor/signalr/jquery.signalR-2.0.2.js',
