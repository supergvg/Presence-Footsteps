                ...
                columnDefs: [
                    ...
                    {field: 'guest.plus', name: 'Plus', enableSorting: false, enableHiding: false, width: 60},
                    {
                        ...
                        cellTemplate: '<div class="ui-grid-cell-contents" style="padding: 0;float: right" title="Checkin">' +
                            ...
                            '<md-icon class="logo-bg" ng-show="grid.appScope.guestPending(row.entity)" style="height: 53px;width: 50px;padding:10px;" md-svg-src="assets/images/SVG/checklist.svg"></md-icon>' +
                            '</md-button>' +
                            '</div>'
                    }
